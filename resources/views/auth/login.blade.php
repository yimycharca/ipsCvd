...
<head>
    ...
    <title>Administrador-loguin</title>
...
<body class="bg-gradient-primary">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <img class="img-fluid rounded d-block m-l-none" src="img/user.png" alt="COVID">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="email"
                                                class="form-control form-control-user form-control @error('email') is-invalid @enderror"
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="{{route('index')}}">Regresar</a>
                                        </div>
    ...
    <script src="extensionesr/bootstrap/js/bootstrap.bundle.min.js"></script>
