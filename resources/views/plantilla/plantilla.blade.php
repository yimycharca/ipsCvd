...
<head>
    ...
    <link href="extensiones/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('graficaperu')}}">
                    <i class="fas fa-map-marked-alt"></i>
                    <span>Mapa del Peru</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('usuario')}}">Login</a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('tab_fallecidos')}}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Tabla Fallecidos</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('tab_positivos')}}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Tabla Casos Positivos</span></a>
            </li>
    ...
    <!-- Page level plugins -->
    <script src="extensiones/datatables/jquery.dataTables.min.js"></script>
    <script src="extensiones/datatables/dataTables.bootstrap4.min.js"></script>
